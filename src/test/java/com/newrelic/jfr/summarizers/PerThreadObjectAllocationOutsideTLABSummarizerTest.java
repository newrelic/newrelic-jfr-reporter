...
class PerThreadObjectAllocationOutsideTLABSummarizerTest {
    ...
    void testSingleEventSummaryAndReset() {
        ...
        var testClass = new PerThreadObjectAllocationOutsideTLABSummarizer(eventThreadName, eventStartTime);
    ...
    void testMultipleEventSummaryAndReset() {
        ...
        List<Metric> expected = List.of(expectedSummaryMetric);
        var testClass = new PerThreadObjectAllocationOutsideTLABSummarizer(eventThreadName, event1StartTime);
